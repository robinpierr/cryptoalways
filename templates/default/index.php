            ...
            <div class="col-xs-12 col-md-6 col-md-push-3 <?php echo $data["custom_main_box_bg"] . ' ' . $data["custom_main_box_tx"]; ?>">
                ...
                <?php break; case "paid":
                    ...
                    <form method="POST" class="form-horizontal" role="form">
                        ...
                        <center><table><td><div class="form-group">
                        ...
                        </div></a></td><td><div class="form-group">
                            <div class="col-sm-offset-1 col-sm-2">
                                <input type="submit" class="btn btn-primary btn-lg claim-button" style="float:left; margin-left:0px; width:160px; height:75px" value="Get reward!">
                            </div>
                        </div></td></table></center>
                        <center>
                        <input type="text" class="form-control" style="float:center; width:470px; height:40px" name="captcha" placeholder="Write the words above for the sake of peace" required />
                        <center>
                    </form>
                    <hr>
                <?php if ($data["reflink"]): ?>
				...
				<center><img src="tools/showCaptcha.php"/></center>
                <?php endif; ?>
